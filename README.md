...
<div align="center">
    <img src="img/mnist_dig_1.png" alt="Representación do nº 1" width="25%" style="margin-right: 20px;"/>
    <img src="img/mnist_dig_2.png" alt="Representación do nº 2" width="25%" style="margin-right: 20px;"/>
