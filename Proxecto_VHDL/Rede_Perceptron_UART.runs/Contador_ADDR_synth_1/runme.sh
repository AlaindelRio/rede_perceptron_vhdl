...
HD_PWD='C:/Users/Alain/Desktop/TFG_Proxecto/Vivado/Rede_Perceptron_UART/Rede_Perceptron_UART.runs/Contador_ADDR_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Contador_ADDR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Contador_ADDR.tcl
