...
HD_PWD='C:/Users/Alain/Desktop/TFG_Proxecto/Vivado/Rede_Perceptron_UART/Rede_Perceptron_UART.runs/Mem_ROM_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mem_ROM_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mem_ROM_3.tcl
