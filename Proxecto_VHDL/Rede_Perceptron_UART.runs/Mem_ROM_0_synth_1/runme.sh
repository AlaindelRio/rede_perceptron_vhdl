...
HD_PWD='D:/Github/Rede_Perceptron_UART/Rede_Perceptron_UART.runs/Mem_ROM_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mem_ROM_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mem_ROM_0.tcl
